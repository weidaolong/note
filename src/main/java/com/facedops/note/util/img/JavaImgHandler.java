...
public class JavaImgHandler implements ImgHandler {
	...
	/** (non-Javadoc)
	 * @see com.facedops.note.util.img.ImgHandler#crop(java.io.File, java.io.File, int, int, int, int, int, int)
	 */
	@Override
	...
	/** (non-Javadoc)
	 * @see com.facedops.note.util.img.ImgHandler#rotate(java.io.File, java.io.File, double)
	 */
	@Override
	...
	/** (non-Javadoc)
	 * @see com.facedops.note.util.img.ImgHandler#scale(java.io.File, java.io.File, int, int, boolean)
	 */
	@Override
	...
	/** (non-Javadoc)
	 * @see com.facedops.note.util.img.ImgHandler#scale(java.io.File, java.io.File, int, boolean)
	 */
	@Override
